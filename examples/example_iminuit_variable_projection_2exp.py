"""
example_iminuit_variable_projection_2exp.py
======================
Minimal example: two-exponential correlator fit via the iminuit + variable projection backend.
...
fig.suptitle("Two-Exponential Correlator Fit  (iminuit + variable projection)", fontsize=14, y=0.98)
...
plt.savefig("plot_iminuit_variable_projection_2exp.pdf", bbox_inches="tight")