"""
example_iminuit_2exp.py
======================
Minimal example: two-exponential correlator fit via the iminuit backend.
...
fig.suptitle("Two-Exponential Correlator Fit  (iminuit backend)", fontsize=14, y=0.98)
...
plt.savefig("plot_iminuit_2exp.pdf", bbox_inches="tight")