"""
example_hybrid_2exp.py
======================
Minimal example: two-exponential correlator fit via the hybrid backend.
...
fig.suptitle("Two-Exponential Correlator Fit  (hybrid backend)", fontsize=14, y=0.98)
...
plt.savefig("plot_hybrid_2exp.pdf", bbox_inches="tight")